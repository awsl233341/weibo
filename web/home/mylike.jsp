   ...
   <div id="main">
    ...
    <div id="mainBanner">
            ...
            <div id="mainBannerTitle">
                ...
                <div id="mainBannerTitleWord"><b>我的赞</b>
                </div>
            ...
            <div id="mainBannerContent">
                ...
                <div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  ...
                  <div class="stateOp"><a class="opState" onclick="javascript:;" href="#">回复 100</a><a class="opState" href="#">转发 100</a><a class="opDone" onclick="unlike(this)" href="#">赞 100</a><a class="opDone" href="#">收藏</a></div>
                  <div class="huifu"></div>
                </div>
                <!--个人展示结束-->
                <!--个人展示，关注的-->
            	<div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  ...
                  <div class="stateOp"><a class="opState" onclick="javascript:;" href="#">回复 100</a><a class="opDone" href="#">转发 100</a><a class="opDone" onclick="unlike(this)" href="#">赞 100</a><a class="opState" href="#">收藏</a></div>
                  <div class="huifu"></div>
                </div>
                 <!--个人展示结束-->
                  <!--个人展示-->
                <div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  ...
                  <div class="stateShowtime"> 07月31日 08:02 </div>
                  <div class="stateOp"><a onclick="javascript:;" class="opDone" href="#">回复 100</a><a class="opState" href="#">转发 100</a><a class="opDone" onclick="unlike(this)" href="#">赞 100</a><a class="opDone" href="#">收藏</a></div>
                  <div class="huifu"></div>
                </div>
                 <!--个人展示结束-->
                 <!--个人展示-->
                <div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  ...
                  <div class="stateShowtime"> 07月31日 08:02 </div>
                  <div class="stateOp"><a onclick="javascript:;" class="opState" href="#">回复 100</a><a class="opState" href="#">转发 100</a><a class="opDone" onclick="unlike(this)" href="#">赞 100</a><a class="opDone" href="#">收藏</a></div>
                   <div class="huifu"></div>
                </div>
                 <!--个人展示结束-->
                  <!--个人展示-->
                <div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  ...
                  <div class="stateShowtime"> 07月31日 08:02 </div>
                  <div class="stateOp"><a onclick="javascript:;" class="opState" href="#">回复 100</a><a class="opDone" href="#">转发 100</a><a class="opDone" onclick="unlike(this)" href="#">赞 100</a><a class="opState" href="#">收藏</a></div>
                   <div class="huifu"></div>
                </div>
                 <!--个人展示结束-->
                 <!--个人展示-->
                <div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  <div class="stateShowWord">
                   ...
                   <div class="stateImgShow"></div>
                  <div class="stateShowtime"> 07月31日 08:02 </div>
                  <div class="stateOp"><a onclick="javascript:;" class="opState" href="#">回复 100</a><a class="opState" href="#">转发 100</a><a class="opDone" onclick="unlike(this)" href="#">赞 100</a><a class="opState" href="#">收藏</a></div>
                   <div class="huifu"></div>
                </div>
                 <!--个人展示结束-->
                  <!--个人展示-->
      ...
      <div id="mainRight1">
                        ...
                        <div id="mainRightPostionSecondLine">
                            ...
                            <div id="mainRightPositionSecondLineContent">
                                ...
                                <hr class="h1">
                                <a href="#" class="a1"><span class="style3">我的赞</span></a>
                            </div>
                            <!-- 右侧mainRightPositionSecondLineContent DIV 开始 -->
                        </div>
