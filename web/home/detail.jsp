      	...
      	<div id="mainBanner">
            ...
            <div id="mainBannerContent">
                <div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)">
                  <div class="stateShowWord">
                    <table width="450" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                      <tr>
                        ...
                        <td width="380"><a href="#">开心段子</a><img src="images/1.gif" style="border:none;vertical-align:middle;" alt=""/>
                  ...
                  <div class="stateOp"><a onclick="reXianShi(this,1)" class="opDone" href="#">回复 100</a><a href="#" class="opState" onclick="reXianShi(this,2)">转发 100</a><a href="#" class="opState" onclick="changeOpState(this)">赞 100</a><a class="opDone" onclick="changeOpState(this)" href="#">收藏</a></div>
                  <div class="huifu">
                          ...
                          <div class="stateRshowWord">
                              <table width="380" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                                  <tr><td width="70" align="center" valign="top"><a href="#"><img src="images/MainRightFirstLineTitle.gif" alt="" width="48" height="48"></a></td>
                                      <td width="310"><a href="#">开心段子</a><img src="images/1.gif" style="vertical-align:middle;border:none;" alt=""/>&nbsp;@DarkDemon&nbsp;&nbsp;你也是够了</td>
                                  </tr>
                              </table>
                          </div>
                          <div class="stateRimgShow"></div>
                          <div class="stateRshowtime">  10月16日 14:59 </div>
                          <div class="stateOp"><a onclick="reXianShi(this,1)" class="opState" href="#">回复 100</a><a class="opState" href="#" onclick="reXianShi(this,2)">转发 100</a><a href="#" class="opDone" onclick="changeOpState(this)">赞 100</a></div>
                      </div>
                      <div class="stateRshow">
                      <div class="stateRshowWord">
                        <table width="380" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                          <tr><td width="70" align="center" valign="top"><a href="#"><img src="images/MainRightFirstLineTitle.gif" alt="" width="48" height="48"></a></td>
                              <td width="310"><a href="#">漂流瓶</a><img src="images/1.gif" style="vertical-align:middle;border:none;" alt=""/>&nbsp;@开心段子&nbsp;&nbsp;你说得也太好了</td>
                          </tr>
                        </table>
                      </div>
                      <div class="stateRimgShow"></div>
                      <div class="stateRshowtime">  10月16日 14:59 </div>
                      <div class="stateOp"><a onclick="reXianShi(this,1)" class="opState" href="#">回复 100</a><a href="#" class="opState" onclick="reXianShi(this,2)">转发 100</a><a href="#" class="opState" onclick="changeOpState(this)">赞 100</a></div>
                    </div>
                    <div class="stateRshow">
                      <div class="stateRshowWord">
                        <table width="380" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                          <tr><td width="70" align="center" valign="top"><a href="#"><img src="images/MainRightFirstLineTitle.gif" alt="" width="48" height="48"></a></td>
                              <td width="310"><a href="#">DarkDemon</a><img src="images/1.gif" style="vertical-align:middle;border:none;" alt=""/>&nbsp;@开心段子&nbsp;&nbsp;快表扬我</td>
                          </tr>
                        </table>
                      </div>
                      <div class="stateRimgShow"></div>
                      <div class="stateRshowtime">  10月16日 14:58 </div>
                      <div class="stateOp"><a onclick="reXianShi(this,1)" class="opState" href="#">回复 100</a><a class="opDone" onclick="changeOpState(this)" href="#">赞 100</a><a class="opState" onclick="delState(this)" href="#">删除</a></div>
                    </div>
                    <div class="stateRshow">
                      <div class="stateRshowWord">
                        <table width="380" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                          <tr><td width="70" align="center" valign="top"><a href="#"><img src="images/MainRightFirstLineTitle.gif" alt="" width="48" height="48"></a></td>
                              <td width="310"><a href="#">DarkDemon</a><img src="images/1.gif" style="vertical-align:middle;border:none;" alt=""/>&nbsp;@开心段子&nbsp;&nbsp;消灭零回复 100</td></tr>
                        </table>
                      </div>
                      <div class="stateRimgShow"></div>
                      <div class="stateRshowtime">  10月16日 14:58 </div>
            ...
            <div id="mainRight1">
               <!-- 右侧mainRightPostionFirstLine DIV 开始 -->
                ...
                <div id="mainRightPostionSixthLine">
                    ...
                    <a href="#" onclick="" class="a1"><span class="style4">相册</span>
                    <img src="images/ThirdLineUpArrow.gif" alt="" width="12" height="14" style="horiz-align: right; border: 0;" title=""/></a>
                    </div>
                    <ul>
                    <li><a href="#" class="a1"><img src="images/WBXM.gif" style="border: none;" alt=""/></a></li>
                    <li><a href="#" class="a1"><img src="images/AXXR.gif" style="border: none;" alt=""/></a></li>
                    <li><a href="#" class="a1"><img src="images/LBXR.gif" style="border: none;" alt=""/></a></li>
                    <li><a href="#" class="a1"><img src="images/WBXM.gif" style="border: none;" alt=""/></a></li>
                    <li><a href="#" class="a1"><img src="images/AXXR.gif" style="border: none;" alt=""/></a></li>
                    <li><a href="#" class="a1"><img src="images/LBXR.gif" style="border: none;" alt=""/></a></li>
                    </ul>
