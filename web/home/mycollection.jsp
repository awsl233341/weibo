    ...
    <div id="mainBanner">
            ...
            <div id="mainBannerContent">
                ...
                <div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  ...
                  <div class="stateOp"><a class="opState" onclick="javascript:;" href="#">回复 100</a><a class="opState" href="#">转发 100</a><a class="opState" onclick="" href="#">赞 100</a><a class="opDone" onclick="removeFromCollection(this)" href="#">收藏</a></div>
                  <div class="huifu"></div>
                </div>
                <!--个人展示结束-->
                <!--个人展示-->
            	<div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  ...
                  <div class="stateOp"><a class="opState" onclick="javascript:;" href="#">回复 100</a><a class="opDone" href="#">转发 100</a><a class="opState" onclick="" href="#">赞 100</a><a class="opDone" onclick="removeFromCollection(this)" href="#">收藏</a></div>
                  <div class="huifu"></div>
                </div>
                 <!--个人展示结束-->
                  <!--个人展示-->
                  ...
                  <div class="stateShowWord">
                    <table width="450" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                      <tr>
                        ...
                        <td width="380"><a href="#">小太阳</a><img src="images/1.gif" style="border:none;vertical-align:middle;"  alt=""/><br/>研发人员自编、自导、自演、自谱、自唱的电影，居然搞这么大动静，影片在网络上累计播放超1000万次。</td>
                      </tr>
                    </table>
                  </div>
                   <div class="stateImgShow"><img src="images/SCT.gif" width="34" height="166" alt="" title="" /></div>
                  <div class="stateShowtime"> 07月31日 08:02 </div>
                  <div class="stateOp"><a onclick="javascript:;" class="opDone" href="#">回复 100</a><a class="opState" href="#">转发 100</a><a class="opState" onclick="" href="#">赞 100</a><a class="opDone" onclick="removeFromCollection(this)" href="#">收藏</a></div>
                  <div class="huifu"></div>
                </div>
                 <!--个人展示结束-->
                 <!--个人展示-->
                <div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  ...
                  <div class="stateShowtime"> 07月31日 08:02 </div>
                  <div class="stateOp"><a onclick="javascript:;" class="opState" href="#">回复 100</a><a class="opState" href="#">转发 100</a><a class="opDone" onclick="" href="#">赞 100</a><a class="opDone" onclick="removeFromCollection(this)" href="#">收藏</a></div>
                   <div class="huifu"></div>
                </div>
                 <!--个人展示结束-->
                  <!--个人展示-->
                <div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)" onclick="go2detail()">
                  ...
                  <div class="stateShowtime"> 07月31日 08:02 </div>
                  <div class="stateOp"><a onclick="javascript:;" class="opState" href="#">回复 100</a><a class="opDone" href="#">转发 100</a><a class="opState" onclick="" href="#">赞 100</a><a class="opDone" onclick="removeFromCollection(this)" href="#">收藏</a></div>
                   <div class="huifu"></div>
                </div>
                 <!--个人展示结束-->
                 <!--个人展示-->
                  ...
                  <div class="stateShowWord">
                    <table width="450" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                      <tr>
                        ...
                        <td width="380"><a href="#">家人杂志</a><img src="images/1.gif" style="border:none;vertical-align:middle;"  alt=""/>分享图片:三十多年前,林青霞和邓丽君在法国戛纳.两位美丽的女子被镜头定格在一起,她们陪伴多少人走过那段流金岁月? </td>
                      </tr>
                    </table>
                  </div>
                   <div class="stateImgShow">
      ...
      <div id="mainRight1">
                        ...
                        <div id="mainRightPostionSecondLine">
                            ...
                            <div id="mainRightPositionSecondLineContent">
                                ...
                                <hr class="h1">
                                <a href="#" class="a1"><span class="style3">我的收藏</span></a>
                                <hr class="h1">
