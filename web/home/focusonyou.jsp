  ...
  <div id="main">
    ...
    <table width="765" border="0" cellpadding="0" cellspacing="0" id="tb1">
      <tr>
        ...
        <td height="60" class="td3"><span style="color: #000000; font-size: medium;"><b>关注你的人（<%=fansCount%>）</b></span></td>
      ...
      <tr>
        ...
        <%
            List<User> fanList =(ArrayList<User>) session.getAttribute("fanList");
      ...
      <tr>
        ...
        <td height="105" align="left" valign="bottom" class="td3"><span style="color: #005dc3; font-size: medium; font-family: 微软雅黑"><b><%=fan.getNickname()%></b></span>
        <img src="<%=fan.getImage()%>" width="17" height="15" alt="" /><br /><span style="color: #000000; font-size: small;"><%=fan.getAddress()%></span>
        <br /><span style="color: #000000; font-size: small;"></span>
        <div id="focus1"><img src="images/ok.png" alt="" width="16" height="16" style="vertical-align: bottom" /> 关注<img src="images/focus.gif" alt="" width="43" height="30" style="vertical-align: bottom" /></div></td>
      </tr>
        <%
            }
        %>
